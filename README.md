...
Download the repository or copy it via:
```bash
git remote add origin https://github.com/Elgoogko/Midterm-exam-Undiknas-MPP.git
```

And lauch the application via:
```bash
flutter run
```

**note**: Make sure you've selected the right device on the bottom left of your IDE; Thanks to Flutter framework, it will work on any device, however you must choose one specific
